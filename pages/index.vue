<template>
  <b-container class="my-5">
    <p>
      My growing collection of tools for CMDRs. These are mostly utilisations of
    ...
    <ul>
      <li>
        <a href="https://eddb.io/">Themroc (EDDB)</a> - For the huge amount of
        data gathered and provided.
      </li>
      <li>
